...
export function issuesMockFactory(count: number) {
  return Array.from({ length: count }, (_: unknown, i: number) => {
    return {
      id: i,
      node_id: `MDU6SXNzdWUx${i}`,
      url: `https://api.github.com/repos/octocat/Hello-World/issues/${i}`,
      repository_url: 'https://api.github.com/repos/octocat/Hello-World',
      labels_url: `https://api.github.com/repos/octocat/Hello-World/issues/${i}/labels{/name}`,
      comments_url: `https://api.github.com/repos/octocat/Hello-World/issues/${i}/comments`,
      events_url: `https://api.github.com/repos/octocat/Hello-World/issues/${i}/events`,
